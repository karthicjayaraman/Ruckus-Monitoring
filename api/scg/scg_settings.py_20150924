...
def get_swatch_config():
	swatch_sql="SELECT * FROM SwatchRegex";
...
def update_swatch():
        ...
        result= g.conn.update('SwatchRegex', conditional_query, id, RegEx=regex)
        json_data={'rows_updated':result}
        return json.dumps(json_data, default=json_util.default)
...
def add_swatch():
        ...
        if request.method == 'POST':
                json_data = request.get_json()
                regex=json_data.get("regex", "")
        result= g.conn.insert('SwatchRegex', RegEx=regex)
        json_data={'row_inserted':result}
        return json.dumps(json_data, default=json_util.default)
...
def delete_swatch():
        ...
        id=int(id)
        conditional_query='RegexID = %s';
        result= g.conn.delete('SwatchRegex', conditional_query, id )
        json_data={'rows_deleted':result}
        return json.dumps(json_data, default=json_util.default)
...
def get_event_config():
        event_sql="SELECT ID, Severity, Regex FROM EventSeverity";
...
def update_event():
        ...
        id=int(id)
        conditional_query='ID = %s';
        result= g.conn.update('EventSeverity', conditional_query, id, Regex=regex, Severity=severity)
        json_data={'rows_updated':result}
        return json.dumps(json_data, default=json_util.default)
...
def add_events():
        ...
        if request.method == 'POST':
                ...
                regex=json_data.get("regex", "")
                severity=json_data.get("severity", "")
        result= g.conn.insert('EventSeverity', Regex=regex, Severity=severity)
        json_data={'row_inserted':result}
        return json.dumps(json_data, default=json_util.default)
...
def delete_events():
        ...
        id=int(id)
        conditional_query='ID = %s';
        result= g.conn.delete('EventSeverity',conditional_query, id )
        json_data={'rows_deleted':result}
        return json.dumps(json_data, default=json_util.default)
...
def get_log_alert_config():
        log_sql="SELECT ID, RegEx, Type FROM Log_Maintain_Regex";
...
def update_log_alert():
        ...
        id=int(id)
        conditional_query='ID = %s';
        result= g.conn.update('Log_Maintain_Regex', conditional_query, id, RegEx=regex, Type=type)
        json_data={'rows_updated':result}
        return json.dumps(json_data, default=json_util.default)
...
def add_log_alerts():
        ...
        if request.method == 'POST':
                ...
                regex=json_data.get("regex", "")
                type=json_data.get("type", "")
        result= g.conn.insert('Log_Maintain_Regex', RegEx=regex, Type=type)
        json_data={'row_inserted':result}
        return json.dumps(json_data, default=json_util.default)
...
def delete_log_alert():
        ...
        id=int(id)
        conditional_query='ID = %s';
        result= g.conn.delete('Log_Maintain_Regex',conditional_query, id )
        json_data={'rows_deleted':result}
        return json.dumps(json_data, default=json_util.default)
...
def get_system_alert():
	system_sql="SELECT * from SystemAlerts";
...
def update_system_alert():
        ...
        id=int(id)
        conditional_query='ID = %s';
        result= g.conn.update('SystemAlerts', conditional_query, id, Status=status)
        json_data={'rows_updated':result}
